            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4">
                <div className="text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-base sm:text-lg lg:text-xl text-gray-200 mb-4 drop-shadow-md">
                        Work with modern technologies, solve real business problems, and grow faster than you ever have. If you want responsibility and impact—not routine—this is your place.
                    </p>
                </div>
            </div>
