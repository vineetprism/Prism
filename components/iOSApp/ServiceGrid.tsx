...
const services = [
    ...
    },
    {
        ...
        desc: <>The &quot;Strangler Pattern&quot; migration service to safely transition Obj-C monoliths to Swift 6 concurrency without business interruption, delivered as part of our advanced <span className="font-bold">iOS app development solutions</span>.</>
    },
    {
        icon: ShieldCheck,
    ...
    },
    {
        ...
        desc: <>On-device Core ML integration for latency-free OCR, biometric auth, and predictive text that respects user privacy, strengthening intelligent <span className="font-bold">iOS app development</span> experiences.</>
    },
    {
        icon: Workflow,
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <span className="text-[#E92228] text-sm font-bold uppercase tracking-widest mb-2 block">
                            Technical Capabilities of Our iOS App Development Services
                        </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {services.map((service, idx) => (
                            <article
                                key={idx}
                                className="group bg-white rounded-2xl p-6 sm:p-8 border-2 border-gray-100 border-t-4 border-t-[#E92228] shadow-sm hover:shadow-none hover:border-[#E92228] transition-all duration-300 motion-reduce:transition-none"
                            >
