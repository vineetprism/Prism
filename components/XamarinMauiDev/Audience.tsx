...
export default function Audience({ onOpenModal }: AudienceProps) {
    const segments = [
        {
            type: "startup",
            headline: "For Startups & SMEs",
            focus: "Speed to Market & Cost Efficiency",
            features: [
                "Launch MVP on iOS and Android simultaneously.",
                "No need for two separate native teams.",
                "Leverage Blazor Hybrid to reuse web assets.",
            ],
            outcome: "Get to market faster with lower burn rate.",
            cta: "See Startup Packages",
        },
        {
            type: "enterprise",
            headline: "For Enterprise & CTOs",
            focus: "Risk Mitigation & Compliance",
            features: [
                "Resolve the Xamarin EOL crisis now.",
                "Meet strict security audit requirements.",
                "Integrate with Azure/Enterprise infrastructure.",
            ],
            outcome: "Mission-critical apps stay compliant and secure.",
                    ...
                    {segments.map((segment, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    onClick={onOpenModal}
                                    className={`cursor-pointer inline-flex items-center gap-2 font-bold px-6 py-3 rounded-full border-2 transition-all ${isEnterprise
