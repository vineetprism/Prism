...
export default function Audience({ onOpenModal }: AudienceProps) {
    const segments = [
        {
            type: "startup",
            headline: "For Startups & Visionaries",
            focus: "Validate Fast, Fail Cheap",
            features: [
                "Rapid prototyping and lightweight MVPs.",
                "Godot or Unity for cost-effective builds.",
                "Prove concept to investors without burning runway.",
            ],
            outcome: "Get to market fit faster.",
            cta: "Build Your MVP",
        },
        {
            type: "enterprise",
            headline: "For Enterprise & Brands",
            focus: "Scale, Security & ROI",
            features: [
                "Integrate with existing CRM/LMS systems.",
                "Strict compliance standards (GDPR/CCPA).",
                "Photorealistic simulations with Unreal + AWS.",
            ],
            outcome: "Gamified marketing engines that deliver ROI.",
