...
import { ClipboardCheck, Rocket, ShieldAlert, TrendingUp } from 'lucide-react';
...
const steps = [
    {
        ...
        desc: "Feasibility audits, MVP scoping, and User Persona mapping. We define the \"Why\" before writing the code."
    },
    {
        icon: Rocket,
        title: "Agile Transition",
        subtitle: "(The Build)",
        desc: "Iterative engineering using SwiftUI for rapid UI dev and Combine for robust data handling. Bi-weekly sprints with visible deliverables."
    },
    {
        icon: ShieldAlert,
        title: "Rigorous Monitoring",
        subtitle: "(The Quality Firewall)",
        desc: "Automated testing via XCTest, memory profiling to catch leaks, and security audits before the binary ever leaves the building."
    },
    {
        icon: TrendingUp,
        title: "Lifecycle Optimization",
        subtitle: "(The Growth)",
        desc: "App Store Optimization (ASO), seamless iOS version updates, and continuous feature integration to prevent churn."
    }
];
