...
export default function Hero({ onOpenModal }: HeroProps) {
    return (
        <section className="relative w-full min-h-[700px] lg:min-h-[800px] overflow-hidden bg-[#1F1F1F]">
            {/* Background Pattern - Circuit/Tech Grid */}
            ...
            <div className="absolute top-20 right-[15%] w-[500px] h-[500px] bg-[#E92228]/15 rounded-full blur-[120px] animate-pulse"></div>
            <div className="absolute bottom-20 left-[10%] w-[400px] h-[400px] bg-[#E92228]/10 rounded-full blur-[100px]"></div>

            {/* Android Robot Silhouette */}
                    ...
                    <div className="w-full lg:w-[60%] xl:w-[65%]">
                        <div className="text-left space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-2">
                                <button
                                    onClick={onOpenModal}
                                    aria-label="Open consultation form to consult our architects"
                            ...
                            <div className="flex items-center gap-2 text-gray-500 text-sm pt-2">
                                ...
                                <span>Adhering to Google&apos;s Android Enterprise Recommended Standards.</span>
                            </div>
                        </div>
                    </div>
