...
const WEBSITE_DEV_SOLUTIONS = [
    ...
    { title: 'Dynamic website development', href: '/service_details/dynamic-website-development' },
    { title: 'PHP Website Development', href: '/service_details/php-website-development' },
    { title: 'CMS Website Development', href: '/service_details/cms-website-development' },
    { title: 'Website Re-development', href: '/service_details/website-re-development' },
    { title: 'Travel Website Development', href: '/service_details/travel-website-development' },
    { title: 'React Js website Development', href: '/service_details/react-js-website-development' },
    { title: 'Angular Website Development', href: '/service_details/angular-website-development' },
    { title: 'Flutter Web Development', href: '/service_details/flutter-web-development' },
    { title: 'Wordpress Development', href: '/service_details/wordpress-development' },
    { title: 'Food Business Web Development', href: '/service_details/food-business-web-development' },
    { title: 'Custom Business Portal Development', href: '/service_details/custom-business-portal-development' },
