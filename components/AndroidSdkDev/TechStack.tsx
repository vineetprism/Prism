...
import { Code2, Layers, Cpu, Paintbrush, FileCode, GitBranch } from 'lucide-react';

const techCategories = [
    {
        icon: Code2,
        title: 'Languages',
        items: ['Kotlin', 'Java 17']
    },
    {
        icon: Layers,
        title: 'Architecture',
        items: ['Kotlin Multiplatform (KMP)', 'Google Jetpack']
    },
    {
        icon: Paintbrush,
        title: 'UI',
        items: ['Jetpack Compose', 'Material Design 3']
    },
    {
        icon: Cpu,
        title: 'Core Libraries',
        items: ['Retrofit', 'OkHttp', 'Room', 'Coroutines/Flow']
    },
    {
        icon: FileCode,
        title: 'Documentation',
        items: ['Dokka', 'Swagger/OpenAPI']
    },
    {
        icon: GitBranch,
        title: 'DevOps',
        items: ['Jenkins/GitLab CI', 'Maven Central', 'Docker']
    }
];
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 font-heading mb-4">
                        Built on the Modern Android Stack
                    </h2>
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto font-body">
                        Industry-standard tools and frameworks for building scalable, performant Android applications.
                    </p>
                </div>
