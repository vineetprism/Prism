...
async function getSeoData() {
    ...
    const url = `${API_BASE.replace(/\/$/, '')}/api/services-seo/gaming-app-development`;
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        title: seo.title || 'Gaming App Development & Gamification Solutions | Prism Infoways',
        description: seo.description || 'Engineered for engagement. From AAA-quality mobile games to enterprise gamification and AR/VR simulations.',
