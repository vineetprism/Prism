...
export async function generateStaticParams() {
    ...
    const hardcodedSlugs = ['android-app-development', 'mobile-app-design', 'swift-app-development', 'flutter-app-development', 'react-native-app-development', 'gaming-app-development', 'xamarin-app-development'];
